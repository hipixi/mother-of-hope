...
const GetInvolved = () => {
  return (
    <section className="rounded-xl bg-muted font-medium  flex justify-center items-center flex-col max-w-screen-xl my-12 md:my-16 py-12 lg:py-24 lg:my-24 px-4 lg:px-8 w-[95%] mx-auto shadow border">
